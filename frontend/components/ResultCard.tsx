// ─────────────────────────────────────────────────────────────────────────────
// V1 (CatBoost) ResultCard — DISABLED. Superseded by ResultCardV2.tsx.
// This component used the V1 /api/v1/explain endpoint (getExplanation) and the V1
// ResultCardProps type, both now disabled. It is no longer exported from
// components/index.ts nor used by any page. The original implementation is kept
// below, commented out for reference.
// ─────────────────────────────────────────────────────────────────────────────
