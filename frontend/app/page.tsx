  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      <DisclaimerBanner
        ...
        message={
          <span>
            For Academic &amp; Research Use Only - Not for Clinical Practice
          </span>
        }
      />
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <section className="mx-auto mb-12 max-w-5xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg text-slate-600 sm:text-xl">
            Clinical Decision Support System powered by CatBoost Machine
            Learning
          </p>
                ...
                <DisclaimerBanner
                  ...
                  message={
                    <span>
                      ...
                      This tool provides AI-generated recommendations based on
                      predictive models. Always verify with current local
                      susceptibility patterns and clinical guidelines. Final
                      treatment decisions should consider patient-specific
                      factors and local antibiograms.
                    </span>
                  }
                />
              </div>
